...
/**
 * LoomCore — the symbolic (Polish-notation) expression engine.
 *
 * This is the raw evaluator that powers both the default `Loom` class
 * (which adds the Plain natural-language surface on top) and direct
 * consumption via `@uniweb/loom/core` for users who want to skip the
 * Plain parser.
 *
 * Supports two modes:
