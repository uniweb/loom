...
- **[basics.md](./basics.md)** — Start here if you're new to Loom. Introduces placeholders, variables, functions, data types, and the main idioms through worked examples.
...
1. **basics.md** (15 min read)
2. **quick-guide.md** (10 min, hands-on)
